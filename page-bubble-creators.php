...
<main class="bsc bsc__page page-bubble-creators">
	<section class="bc__intro" aria-labelledby="bc-title">
		<div class="bc__intro-logo" aria-hidden="true">
			<img src="<?php echo esc_url( $theme_uri . '/images/bubble-creators-face.png' ); ?>" width="556" height="482" alt="">
		</div>
	...
	<section class="bc__benefits" aria-label="Beneficios Bubble Creators">
		<article class="bc__benefit-card bc__benefit-card--yellow">
			<img class="bc__benefit-icon bc__benefit-icon--rainbow" src="<?php echo esc_url( $theme_uri . '/images/bubble-creators-rainbow.png' ); ?>" width="300" height="300" alt="" aria-hidden="true">
		...
		<article class="bc__benefit-card bc__benefit-card--blue">
			<img class="bc__benefit-icon bc__benefit-icon--stars" src="<?php echo esc_url( $theme_uri . '/images/bubble-creators-stars.png' ); ?>" width="300" height="300" alt="" aria-hidden="true">
		...
		<article class="bc__benefit-card bc__benefit-card--pink">
			<img class="bc__benefit-icon bc__benefit-icon--heart" src="<?php echo esc_url( $theme_uri . '/images/bubble-creators-heart.png' ); ?>" width="300" height="300" alt="" aria-hidden="true">
			<h2>Experiencias</h2>
			<div class="bc__benefit-box">
	...
	<section class="bc__form-section" id="bc-form" aria-labelledby="bc-form-title">
		...
		<div class="bc__form-success" id="bc-form-success">
			<div class="bc__form-success-inner">
				<img class="bc__form-success-face" decoding="async" src="<?php echo esc_url( $theme_uri . '/images/bsc_profile_logo.png' ); ?>" width="370" height="232" alt="Perfil BSC">
