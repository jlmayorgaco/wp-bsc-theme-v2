...
- Asegurar que bundle y webhook limpien `ROADMAP_BSC.md`, `CLAUDE.md`, tests, tools, Sass, configs y artefactos ZIP.
...
- `npm run bundle`: verde; el ZIP no contiene `ROADMAP_BSC.md`, `CLAUDE.md`, `composer.json`, `package.json`, `phpstan-baseline.neon`, `sass/`, `style.css.map`, `tools/`, `tests/`, `admin.zip` ni `admin2.zip`.
