...
<main class="bsc bsc__product--page">
	...
	<div class="bsc__product-recommendations">
		...
		if ('' === $recommendations_html) {
			...
			// The slider renderer escapes its dynamic values and this markup must retain
			// WordPress responsive image attributes such as srcset and sizes.
			echo $recommendations_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Generated by the escaped internal product-card renderer.
		}
		?>
		</div>
	</div>
