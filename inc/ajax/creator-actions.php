...
function bsc_creator_apply() {
    ...
    if (!bsc_creator_is_platform_url($instagram, 'instagram.com')) {
        wp_send_json_error(['message' => 'Por favor ingresa un link valido de Instagram.']);
    }
    ...
    wp_send_json_success(['message' => 'Gracias por tu solicitud. El equipo de BSC revisara tu perfil y se pondra en contacto contigo pronto.']);
}
