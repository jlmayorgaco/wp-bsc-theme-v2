...
if (!function_exists('bsc_2_0_setup')) {
    function bsc_2_0_setup() {
        ...
        register_nav_menus(['menu-1' => esc_html__('Primary', 'bsc-2-0')]);
...
if (!function_exists('bsc_create_default_pages')) {
    function bsc_create_default_pages() {
        $pages = [
            ['slug' => 'login', 'title' => 'Iniciar Sesión', 'template' => 'page-login.php'],
            ['slug' => 'register', 'title' => 'Registrarse', 'template' => 'page-register.php'],
            ['slug' => 'mi-cuenta', 'title' => 'Mi Cuenta', 'shortcode' => '[woocommerce_my_account]'],
            ['slug' => 'bubble-points', 'title' => 'Bubble Points', 'template' => 'page-bubble-points.php', 'parent' => 'mi-cuenta']
        ];
