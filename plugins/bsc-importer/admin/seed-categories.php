...
function bsc_theme_importer_after_upload_categories() {
	...
	$menus = array(
		...
		'Rutina Básica'     => array(
			...
			'children' => array(
				array(
					...
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s2-limpiadores-acuosos',
				),
				array(
					'name' => 'Tónico',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s4-tonicos',
				),
				array(
					'name' => 'Hidratante',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s9-hidratantes',
				),
				array(
					'name' => 'Protector Solar',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s10-protectores-solares-crema',
				),
			),
		),
		'Rutina Intermedia' => array(
			...
			'children' => array(
				array(
					'name' => 'Limpiador Aceitoso',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s1-limpiadores-aceitosos',
				),
				array(
					'name' => 'Limpiador Acuoso',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s2-limpiadores-acuosos',
				...
				array(
					'name' => 'Serum',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s7-serums',
				),
				array(
					'name' => 'Hidratante',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s9-hidratantes',
		...
		'Rutina Experta'    => array(
			...
			'children' => array(
				...
				array(
					'name' => 'Exfoliante',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s3-exfoliantes',
				),
				array(
					'name' => 'Tónico',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s4-tonicos',
				...
				array(
					'name' => 'Mascarilla',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s5-mascarillas',
				),
				array(
					'name' => 'Esencias',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s6-esencias',
				),
				array(
					'name' => 'Serum',
					'url'  => '/product-category/group-skin-care/sk-rutina/sk-rutina-s7-serums',
		...
		'BLOG'              => array(
			...
			'children' => array(
				...
				array(
					'name' => 'Skin Care',
					'url'  => '/product-category/group-skin-care',
				),
				array(
					'name' => 'Hair Care',
					'url'  => '/product-category/group-hair-care',
				),
				array(
					'name' => 'Maquillaje',
					'url'  => '/product-category/group-make-up',
				),
			),
		),
	);
