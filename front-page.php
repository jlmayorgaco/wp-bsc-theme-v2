	...
	<section class="section home__products--section">
			...
			<div class="section__container">
				...
				<div class="tabs__header tabs__headers--favs">
					...
					<svg class="tab__icon tab__icon--accent tab__icon--hair-care" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 79" aria-hidden="true" focusable="false">
						<g transform="translate(42.2 3) scale(.62)">
							<path class="cls-2" d="M25.9,7.36c0-1.93-.76-3.74-2.15-5.1C22.24.78,20.16-.05,18.03,0,13.14.08,7.89.27,2.6,1.08c-.94.14-1.71.69-2.18,1.54-.5.9-.56,1.99-.16,2.9.31.71.91,1.06,1.82,1.06l13.08.03.24,2.08-14.03.03c-.8,0-1.19.27-1.27.87-.04.3.03.72.26.99.15.17.34.25.57.25l14.48.05-.02,2.21-14.6.05-.15.03c-.19.08-.35.27-.45.54-.16.42-.13.88-.04,1.15l.06.16.16.06c.46.18.91.27,1.29.27h13.76s-.05,2.2-.05,2.2l-14.49.03c-.21,0-.39.1-.53.28-.21.29-.27.72-.2.97.18.62.56.89,1.23.89h14.01s.03,2.15.03,2.15H2.23c-.57.02-1.08.09-1.79.26l-.29.07.04,1.66.25.08c.44.14.87.22,1.22.22h13.78s-.06,2.19-.06,2.19l-14.82.07-.09.06c-.26.17-.4.77-.37,1.02.03.25.25.96.71.96l14.59.05.02,2.19-14.6.03c-.13,0-.26.06-.37.17-.23.24-.35.69-.34.92,0,.31.27,1.05.74,1.05l14.59.07-.07,2.16H7.1s-6.59.11-6.59.11l-.1.1c-.17.16-.33.71-.32.97.02.26.2.69.43.89l.1.09,14.76.02.02,2.21-14.57.05c-.52,0-.73.74-.73,1.05,0,.22.11.66.35.9.11.11.23.16.36.16l14.47.04h0c.1.62.15,1.31-.2,2.15l-12.76.02c-1.29,0-2.15.77-2.25,1.99-.11,1.3.44,2.85,1.69,3.29,1.29.44,2.59.63,3.98.84.52.08,1.05.15,1.57.24l5.26.92c1.16.2,2.15,1.02,2.53,2.07.35.99.45,2.17.3,3.51-.28,2.53-.71,4.94-1.25,7.79l-2.02,10.47c-.54,2.8-1.03,6.86.91,9.76,1.35,2,3.57,3.14,5.87,3.14.77,0,1.54-.13,2.3-.39,2.81-.98,4.69-3.65,4.69-6.64V7.36ZM12.86,48.95l-8.97-1.46c-.83-.13-1.45-.39-1.8-1.2.55-.14,1.13-.27,1.71-.27l11.2-.03c1.12,0,2.49-1.08,2.49-2.33V7.34c0-1.37-1.04-2.68-2.24-2.8-2.01-.2-4.11-.17-6.33-.13v.38s-.1-.37-.1-.37c-2.22.03-4.52.07-6.68-.16.11-.34.44-1,.84-1.06,5.03-.66,10.12-.99,15.58-1,2.77,0,4.99,2.3,5.17,5.32v73.23c-.25,2.01-.96,3.34-2.24,4.18-.75.49-1.64.75-2.57.75-1.39,0-2.69-.57-3.56-1.56-1.97-2.23-1.58-6.12-1.17-8.24l1.84-9.54c.54-2.79,1.09-5.67,1.44-8.76l.05-3.3c-.15-2.75-2.03-4.89-4.66-5.32Z"></path>
							<path class="cls-1" d="M18.57,1.82c-5.25.01-10.38.31-15.63,1-.71.09-1.08,1.11-1.15,1.31l-.15.44.46.05c2.2.23,4.54.19,6.79.16,2.22-.04,4.32-.07,6.32.13.99.1,1.9,1.26,1.9,2.43v36.31c0,1.03-1.18,1.95-2.12,1.95l-11.2.03c-.62,0-1.23.14-1.8.29l-.42.11.17.4c.44,1.02,1.26,1.29,2.08,1.42l8.97,1.46c2.46.4,4.21,2.4,4.35,4.97l-.05,3.27c-.34,3.06-.9,5.95-1.44,8.74l-1.83,9.5c-.42,2.19-.82,6.21,1.25,8.56.98,1.11,2.41,1.69,3.85,1.69.97,0,1.94-.26,2.77-.81,1.39-.91,2.15-2.32,2.41-4.47V7.52c-.19-3.24-2.57-5.68-5.54-5.69Z"></path>
						</g>
						<path class="cls-2" d="m90.9,69.4h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-1c-.6,0-1-.4-1-1s.4-1,1-1h1c.6,0,1,.4,1,1s-.4,1-1,1Zm-9,0h-.9c-.6,0-1-.4-1-1s.4-1,1-1h.9c.6,0,1,.4,1,1s-.4,1-1,1Z"></path>
					</svg>
