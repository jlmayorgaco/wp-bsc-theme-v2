    ...
    <div class="login__form">
      ...
      <div class="form__fields">
        ...
        <form name="loginform" id="loginform" action="<?php echo esc_url(wp_login_url()); ?>" method="post" class="form">
          ...
          <div class="form__field form__field--submit">
            <a href="<?php echo esc_url(home_url('/register/')); ?>" style="padding: 10px 30px; font-size:17px;" class="bsc__signin_btn form__submit btn btn--primary">
              ¡ Crear mi cuenta !
            </a>
          </div>

          <div class="form__links">
            <a class="form__link no-link">No tienes cuenta? Unete a BSC</a>
          </div>
