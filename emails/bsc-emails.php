 ...
 */
function bsc_send_order_email( int $order_id, string $status, array $extra = array() ): bool {
	...
	$dedupe_key = md5( wp_json_encode( array( $status, $extra['tracking_code'] ?? '', $extra['tracking_link'] ?? '' ) ) );
