...
bsc_email_render_message(
	sprintf(
		'Hola <strong>%s</strong>, ya haces parte de Bubble Skin Care.<br>Desde ahora tendrás acceso a tus pedidos, bubble points<br>y todo lo necesario para seguir construyendo tu rutina coreana con<br>nosotros. <strong>¡ Gracias por confiar en BSC :) !</strong>',
...
?>
				...
				<tr>
					<td align="center" class="bsc-email-section-title" style="color:#303030;<?php echo esc_attr( bsc_email_typography_style( 'section-title' ) ); ?>padding:0 44px 34px;">
