...
bsc_email_render_message(
	sprintf(
		'Hola <strong>%s</strong>, ya estamos preparando tu pedido <strong>#%s</strong>.Lo alistaremos con mucho cuidado y te avisaremos cuando salga con su número de seguimiento :)',
