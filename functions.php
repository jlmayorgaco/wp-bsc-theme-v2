 ...
 */
function bsc_2_0_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'bsc-2-0' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'bsc-2-0' ),
...
add_action( 'widgets_init', 'bsc_2_0_widgets_init' );
